# 스키마 마크업이란? AI 검색엔진이 콘텐츠를 이해하게 만드는 구축 방법
# 스키마 마크업이란?
Schema Markup(스키마 마크업)이란, 검색엔진과 AI가 웹페이지의 내용을 정확하게 이해할 수 있도록 구조화된 형식으로 데이터를 표시하는 코드입니다. Schema.org 표준을 따르며, JSON-LD 포맷으로 HTML에 삽입합니다.
